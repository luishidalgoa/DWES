...
<?php
     ...
     if (isset($_POST['boton_enviar'])) { //isset verifica que un campo no este vacio
          $nombre = $_POST['nombre'];
...
?>   
          <form name="input"      action="<?php $_SERVER['PHP_SELF'];?>"      method="post">  <!--$_SERVER['PHP_SELF'] vuelve a ejecutar el mismo archivo-->
